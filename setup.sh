...
echo -e "${CYAN}    infernorecon 192.168.1.100${NC}"
echo -e "${CYAN}    infernorecon example.com --skip-web${NC}"
echo -e "${CYAN}    infernorecon 10.10.10.10 --skip-rustscan --threads 100${NC}"
